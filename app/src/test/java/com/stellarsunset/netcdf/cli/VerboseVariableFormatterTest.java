...
class VerboseVariableFormatterTest {

    private static final VariablePrinter.Formatter.Verbose FORMATTER = new VariablePrinter.Formatter.Verbose();
    ...
    void testVariableText() {
        ...
        Variable variable = Variable.builder()
                ...
                .addAttribute(Attribute.builder()
                        .setName("description")
                        .setStringValue("My variable is a great variable, probably one of the best.")
                        .build())
                .build(group);
        ...
        assertAll(
                ...
                () -> assertTrue(text.contains(variable.getDescription()), "Should contain variable description")
        );
    }
}